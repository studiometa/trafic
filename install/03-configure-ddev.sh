...
sudo cp $TRAFFIC_ROOT_DIR/config/traefik/static_config.ddev-server.yaml /home/ddev/.config/ddev/traefik/
sudo chown ddev:ddev /home/ddev/.config/ddev/traefik/static_config.ddev-server.yaml
sudo cp $TRAFFIC_ROOT_DIR/config/traefik/default_config.yaml /home/ddev/.config/ddev/traefik/config/
